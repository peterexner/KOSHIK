...
public class ChineseWikipediaPage extends WikipediaPage {
	...
	private static final String IDENTIFIER_REDIRECTION2_UPPERCASE = "#REDIRECT";
	private static final String IDENTIFIER_REDIRECTION2_LOWERCASE = "#redirect";
	...
	private static final Pattern disambiguationPattern = Pattern.compile("\\{\\{disambig\\|", Pattern.CASE_INSENSITIVE);
	...
	protected void parsePageType() {
		...
		this.isRedirectionPage = this.wikiText.contains(IDENTIFIER_REDIRECTION_UPPERCASE) || 
								 ...
								 this.wikiText.contains(IDENTIFIER_REDIRECTION2_UPPERCASE) ||
								 this.wikiText.contains(IDENTIFIER_REDIRECTION2_LOWERCASE);
