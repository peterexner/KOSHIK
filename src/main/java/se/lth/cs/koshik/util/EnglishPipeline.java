...
public class EnglishPipeline extends Configured implements Tool {
	...
	private static class EnglishPipelineReducer extends Reducer<AvroKey<AvroDocument>, NullWritable, AvroKey<AvroDocument>, NullWritable> {
		...
		protected void setup(Context context) throws IOException {
			...
			is2Lemmatizer = new IS2Lemmatizer("CoNLL2009-ST-English-ALL.anna-3.3.lemmatizer.model");
			is2POSTagger = new IS2POSTagger("CoNLL2009-ST-English-ALL.anna-3.3.postagger.model");
			is2SyntacticDependencyParser = new IS2SyntacticDependencyParser("CoNLL2009-ST-English-ALL.anna-3.3.parser.model");
			lthSemanticRoleLabeler = new LTHSemanticRoleLabeler("CoNLL2009-ST-English-ALL.anna-3.3.srl-4.1.srl.model", Language.L.eng);
		}
