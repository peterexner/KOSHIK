...
public class CoNLL2009FileImportMapper extends Mapper<Text, Text, AvroKey<AvroDocument>, NullWritable> {
	private AvroKey<AvroDocument> avroKey;
	private CoNLL2009Reader coNLL2009Reader;
	
	@Override
	protected void setup(Context context) {
		avroKey = new AvroKey<AvroDocument>(null);
		coNLL2009Reader = new CoNLL2009Reader();
	}
	...
	protected void map(Text fileName, Text content, Context context)
		...
		coNLL2009Reader.read(content.toString(), document);
